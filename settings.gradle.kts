...
include(":ktor-client:ktor-client-features:ktor-client-content-negotiation")
include(":ktor-client:ktor-client-features:ktor-client-content-negotiation:ktor-client-content-negotiation-tests")
